...
function setup() {
  ...
  beta = 0;
  gamma = 0;
rock =  loadImage("assets/rock2.png");
star =  loadImage("assets/star2.png");
...
function draw() {
  ...
  textSize(40);
  textAlign(CENTER);
  text("My little stars", width / 2, 600, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  //ellipse(this.pos.x + 50, this.pos.y, 50, 50);
    ...
    image(star, this.pos.x, this.pos.y,100,100);
  }
